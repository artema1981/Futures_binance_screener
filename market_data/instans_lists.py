...
class RenderDataBooks:
    ...
    def get_unit_data(self):
        ...
        if any([spot_data.get('best_ask'), spot_data.get('best_bid'), future_data.get('best_ask'), future_data.get('best_bid')]):
            ...
            print([spot_data.get('best_ask'), spot_data.get('best_bid'), future_data.get('best_ask'),
